...
public class VP extends javax.swing.JFrame {
    ...
    public VP() throws BadIdRecintoException {
        ...
        // Center the backgroundPnl in the middle
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.insets = new Insets(0, 0, 0, 0);  // No padding around the panel
        gbc.anchor = GridBagConstraints.CENTER;
        gbc.weightx = 1.0;
        gbc.weighty = 1.0;
        
        // Add the backgroundPnl (the 1024x768 panel) with the centered constraints
        add(backgroundPnl, gbc);
        
        // Set the preferred size of the panel to 1024x768 (fixed size)
        backgroundPnl.setPreferredSize(new java.awt.Dimension(1024, 768));
        
        // Make sure resizing works properly
        pack();
