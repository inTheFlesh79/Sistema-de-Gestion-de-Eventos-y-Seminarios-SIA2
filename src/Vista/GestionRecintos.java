...
public class GestionRecintos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        recintosTblLR.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Recinto", "Nombre del Recinto", "Ubicacion", "Capacidad"
            }
        ) {
        ...
        if (recintosTblLR.getColumnModel().getColumnCount() > 0) {
            recintosTblLR.getColumnModel().getColumn(0).setPreferredWidth(40);
            recintosTblLR.getColumnModel().getColumn(1).setPreferredWidth(150);
            recintosTblLR.getColumnModel().getColumn(2).setPreferredWidth(250);
            recintosTblLR.getColumnModel().getColumn(3).setPreferredWidth(30);
        }
    ...
    private void aceptarBtnDRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarBtnDRActionPerformed
        if (!"".equals(nombreRecintoFieldDR.getText()) &&
            ...
            try{
                ...
                if (!menu.modificarRecinto(idRecintoFieldMR.getText(), nombreRecintoFieldDR.getText(), ubicacionFieldDR.getText(), cuposFieldDR.getText())){
                    JOptionPane.showMessageDialog(null, "ERROR: El recinto no pudo ser modificado correctamente en el sistema. "
    ...
    private void buscarIdRecintoBtnLRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarIdRecintoBtnLRActionPerformed
        if (!"".equals(idRecintoFieldLR.getText())){
            menu.mostrarRecintos(getRecintosTblLRModel(), idRecintoFieldLR.getText());//FALTA UN IF PARA TIRAR CUADRO DE DIALOGO SI NO ESTA EL RECINTO
        }
        else{
            JOptionPane.showMessageDialog(null, "Los campos se encuentran vacios", "Field Error", JOptionPane.ERROR_MESSAGE);
            menu.mostrarRecintos(getRecintosTblLRModel());
